...
export default function ControleAside() {
  ...
  return (
    <div className="fixed z-30 lg:mt-16 lg:text-xl bg-mColor lg:top-0 left-0 right-0 lg:left-auto  lg:border-r-4 lg:border-r-slate-500">
      <div className="container pt-4">
        ...
        {/* start navBar list */}
        <nav>
         <ul className={`hidden${openToggle?"block":""} lg:block py-2 rounded-md divide-y divide-slate-500 border-slate-500 border-2  mt-4 lg:m-0 shadow-md lg:rounded-0 lg:border-0`}>
            <li>
              <Link
                href="/controle"
                className={`${
                  path === "/controle"
                    ? "text-sColor font-semibold"
                    : ""
