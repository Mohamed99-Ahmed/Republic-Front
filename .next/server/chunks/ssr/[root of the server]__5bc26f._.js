...
"[project]/context/category.context.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const categoryContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])();
function CategoryContext({ children }) {
    ...
    async function getAllCategories() {
        try {
            ...
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].request(options);
            console.log(data);
            return data;
        } catch (err) {
            console.log(err);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5bc26f._.js.map